...
function SunSignCalculator() {
  ...
  return (
    <>
      <Helmet>
        <title>Sun Sign Calculator</title>
        <meta name="description" content="Sun sign calculator - Calculate your Vedic sun sign and understand its influence on your core personality, ego, and life purpose." />
        <link rel="canonical" href="https://www.vedicastrologycalculator.com/sun-sign-calculator" />
      </Helmet>
        ...
        <main className="container mx-auto px-4 py-8">
          ...
          <section className="mb-12">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <Link to="/moon-sign-calculator" className="calculator-link">
                Moon Sign Calculator
              </Link>
              <Link to="/rising-sign-calculator" className="calculator-link">
                Rising Sign Calculator
              </Link>
              <Link to="/nakshatra-calculator" className="calculator-link">
