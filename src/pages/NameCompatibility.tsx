...
function NameCompatibilityCalculator() {
  ...
  return (
    <>
      <Helmet>
        <title>Name Compatibility Calculator</title>
        <meta name="description" content="Name compatibility calculator - Check relationship compatibility based on names. Get detailed analysis of emotional, intellectual, and practical harmony." />
        <link rel="canonical" href="https://www.vedicastrologycalculator.com/name-compatibility-calculator" />
      </Helmet>
        ...
        <section className="max-w-3xl mx-auto mb-12">
          ...
          <section className="max-w-3xl mx-auto mb-12">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <Link to="/upapada-lagna-calculator" className="calculator-link">
                <div className="flex items-center gap-3 justify-center">
                  <Star className="h-5 w-5 text-sky-700" />
